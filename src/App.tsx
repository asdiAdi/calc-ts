...
function App() {
  return (
    <div className='flex items-center justify-center md:h-[58rem] h-[36rem]'>
      ...
      <div id='outer-shell' className=" bg-outer-violet aspect-[282/570] rounded-[50%50%100%100%/20%20%30%30%] h-[95%] flex items-center justify-center">
        <div id='inner-shell' className="bg-inner-gray h-[97.52%] w-[97.52%] rounded-[50%50%100%100%/20%20%30%30%]">
