    ...
    <div className='flex items-center justify-center md:h-[58rem] h-[36rem]'>
      ...
      <div id='outer-shell' className=" bg-outer-violet aspect-[282/570] rounded-[40%40%50%50%/3%3%9%8%] h-[95%] flex items-center justify-center">
        <div id='outer-shell2' className="bg-background h-[97.52%] w-[97.52%] rounded-[40%40%50%50%/3%3%9%8%]">
          ...
          <div id="middle-button" className="flex justify-center items-center bg-red-200 h-[23.67%] w-auto">
          ...
          <div id="bottom-button" className="bg-blue-200 h-[28.11%] w-auto flex justify-center items-center">
            <div id='mid-grid' className='grid grid-cols-6 h-full w-[84.9265%] place-items-center text-center'>
             <div className='w-[90.9091%] h-[90.2256%] flex justify-center flex-wrap'>
                <div className='text-text-brown w-[50%] h-[30%] text-xs text-left'>&nbsp;SOLVE </div>
                <div className='text-text-red w-[50%] h-[30%] text-xs text-right'>=&nbsp;</div>
